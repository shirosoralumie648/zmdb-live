...
export default {
    ...
    segment: {
        normal: {
            IntervalTooLong: {
                code: 400101130,
                message: `切片时长不应超过${validation.segment.normal.interval.upperLimit / 60000 }分钟`
            },
            IntervalTooShort: {
                code: 400101131,
                message: `切片时长不应少于${validation.segment.normal.interval.lowerLimit / 1000 }秒钟`
            }
        },
        danmaku: {
            IntervalTooLong: {
                code: 400101132,
                message: `切片时长不应超过${validation.segment.danmaku.interval.upperLimit / 60000 }分钟`
            },
            IntervalTooShort: {
                code: 400101133,
                message: `切片时长不应少于${validation.segment.danmaku.interval.lowerLimit / 1000 }秒钟`
            }
        }
    }
}