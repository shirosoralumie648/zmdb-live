        ...
        <Dialog fullscreen='true' fullWidth={true} maxWidth='xl' open={status} onClose={onClose}>
            <DialogContent sx={{ display:'flex', height:'50rem', mt:'1px' }}>
                ...
                <Box sx={{flex:35, ml:'1rem'}}>
                    ...
                    {
                        clip.type === 1 ?
                        <iframe title={clip.title} width="100%" height="360" src={`//${clip.playUrl}&t=${currentTime}`} border="0" frameBorder="no" framespacing="0" allowFullScreen={true}></iframe> :
                        <ArtPlayer
                            option={{
                                url: `${clip.playUrl}`,
                                poster: `${clip.cover}`,
                                ...
                                danmakuUrl: clip.type === 2 ? `${clip.playUrl.replaceAll('.mp4', '.xml').replaceAll('/d/', '/p/')}` : `${clip.playUrl.replaceAll('.mp4', '.xml').replaceAll('.flv', '.xml')}`,
                                // thumbnailsUrl: `${clip.playUrl.replaceAll('.mp4', '.jpg')}`,
                            }}
                            style={{
                                width: '100%',
                                height: '360px'
